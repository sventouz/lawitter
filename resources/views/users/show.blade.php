                ...
                <div class="col-md-8 mb-3">
                    <div class="card">
                        ...
                        <div class="card-footer py-1 d-flex justify-content-end bg-white">
                            ...
                            <p>delete</p>
                                <!-- いいね取り消しフォーム -->
                                {{ Form::model($timeline, array('action' => array('LikesController@destroy', $timeline->id, $like->id))) }}
                                <button type="submit">
                                    ♡ いいね {{ $timeline->likes_count }}
                                </button>
                                {!! Form::close() !!}
                                @else
                                <p>add</p>
                                <!-- いいねフォーム -->
                                {{ Form::model($timeline, array('action' => array('LikesController@store', $timeline->id))) }}
                                    <button type="submit">
                                    + いいね {{ $timeline->likes_count }}
                                    </button>
                                {!! Form::close() !!}
